...
const ApprovalProfileCard = ({requestNumber, user, department, contact, location,}) => {
  return (
    <div className="flex flex-col  md:mr-4 cardConatiner rounded-[20px] p-4 max-w-[400px]">
