...
const DoubleDutyPage = () => {
  ...
  <div className="flex items-center gap-[50px] pr-4">
        ...
        <div className="flex items-center gap-[20px]">
          <p className="font-bold text-[40px]">Double Duty</p>
          <p className="font-bold text-[24px] pt-4">11</p>
    ...
    <table className="min-w-full border border-blue-500 rounded-lg">
      <thead className="bg-red-500 text-white">
        <tr>
          ...
          <th className="px-4 py-2 border">1st Site Name</th>
          <th className="px-4 py-2 border">1st Site Code</th>
          <th className="px-4 py-2 border">1st site Date & Time</th>
          <th className="px-4 py-2 border">2nd Site Name</th>
          <th className="px-4 py-2 border">2nd Site Code</th>
          <th className="px-4 py-2 border">2nd site Date & Time</th>
