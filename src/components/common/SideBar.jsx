  ...
  return (
    <div className='w-[18vw] min-h-[100vh] h-full border-r border-r-1 border-r-[#F02946]'>
        <div className='py-[20px]'>
            ...
            >
                <span>
                    {path.startsWith("/visit") ?   <img src="../icons/Vector (54).png" alt="" /> :  <img src="../icons/Vector (53).png" alt="" />
                    }
                </span>
            ...
            >
                <span>
                    {path.startsWith("/visit") ?   <img src="../icons/Vector (56).png" alt="" /> :  <img src="../icons/Vector (55).png" alt="" />
                    }
                </span>
                <p>Site</p>
            ...
            >
                <span>
                    {path.startsWith("/visit") ?   <img src="../icons/Vector (64).png" alt="" /> :  <img src="../icons/Vector (63).png" alt="" />
                    }
                </span>
