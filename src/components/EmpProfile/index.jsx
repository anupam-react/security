      ...
      <div className="bg-[url('https://cdn.pixabay.com/photo/2020/05/04/10/21/background-5128586_1280.jpg')] bg-cover h-[200px] w-full flex justify-between rounded-t-[20px] ">
        <div className="flex gap-[50px] px-4 ">
          ...
          />
            ...
            <div className="font-bold text-[40px] text-white">Profile</div>
          
        </div>
      <div onClick={()=>navigate('/employee/update-profile')} className="border border-white h-[30px] w-[80px] m-4 rounded-lg flex items-center justify-center gap-2 cursor-pointer">
